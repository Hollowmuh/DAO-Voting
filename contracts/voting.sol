...
contract Voting {
    ...
    uint256 private constant maxActiveProposal = 5;
    uint256 private constant maxYearlyProposalPerUser = 5;
    uint256 private constant minLockPercentage = 10;
    uint256 proposalDelay = 50 seconds;
    uint256 private constant maxVoteWeight = 10**4;
    ...
    function processPendingProposals() public {
        ...
        for (; nextProposal <= maxActiveProposal; ++nextProposal) {
            ...
            if (block.timestamp >= proposalCreationTimes[proposalId] + proposalDelay && !proposalInVoting[proposalId]) {
...
//0x9396B453Fad71816cA9f152Ae785276a1D578492//  SPDX-License-Identifier: MIT
